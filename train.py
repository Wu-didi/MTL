...
import sys
sys.path.insert(0,'/mnt/e/python_file/MTL-master')
...
import sys
from code_v2.optim import *
from code_v2.utils import utils as utils
from code_v2.benchmarks.mtl_benchmark import get_benchmark_class
...
class MTLTrainer:
    def __init__(self, args):
        ...
        self.model = self.benchmark.get_model(args) # PSPNetCityscapes 一个模型对应三个分支
